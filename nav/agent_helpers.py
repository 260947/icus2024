...
class Agent():
    def __init__(self, agent_cfg, camera_cfg, blender_cfg) -> None:
        ...
        self.path = camera_cfg['path']#相机参数路径
        self.half_res = camera_cfg['half_res']#是否使用一半分辨率
        self.white_bg = camera_cfg['white_bg']#是否白色背景
        ...
        self.x = agent_cfg['x0'] #状态
        self.dt = agent_cfg['dt'] #时间间隔 ，0.1
        self.g = agent_cfg['g'] #重力加速度，10
        self.mass = agent_cfg['mass'] #质量 ，1
        self.I = agent_cfg['I'] #单位矩阵
    ...
    def step(self, action, noise=None):
        ...
        new_state = newstate_noise.clone().detach()#世界坐标系
